...
<head>
    ...
    <meta itemprop="description" content="新ikun音游" />
    <meta charset="utf-8" />
...
<body onLoad="init()" oncontextmenu=self.event.returnValue=false>
    <div id="GameScoreLayer" class="BBOX SHADE bgc1" style="display:none;">
        <div style="padding:5%;margin-top: 200px;background-color: rgba(125, 181, 216, 0.3);">
                ...
                <button type="button" class="btn btn-secondary btn-lg" onclick="window.location.href='https://github.com/azdyqwo/EatKunRank'" data-i18n="repo">REPO-I18N</button>
                <button type="button" class="btn btn-secondary btn-lg" onclick="window.location.href='http://azdyqwo-ovo.669.ink/blog'" >Blog</button>
            </div>
    </div>
    </div>
